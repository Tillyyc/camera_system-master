...
#
# Generated by export_simulation on Sun Mar 24 18:36:38 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './ram_data_in.sh' script.

./ram_data_in.sh -reset_run
...
./ram_data_in.sh -noclean_files

For more information on the script, please type './ram_data_in.sh -help'.
