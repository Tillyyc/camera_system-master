...
#
# Generated by export_simulation on Tue Apr 02 18:27:05 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './weights.sh' script.

./weights.sh -reset_run
...
./weights.sh -noclean_files

For more information on the script, please type './weights.sh -help'.
