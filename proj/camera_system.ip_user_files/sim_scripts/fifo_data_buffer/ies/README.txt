...
#
# Generated by export_simulation on Sun Mar 24 18:42:38 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_data_buffer.sh' script.

./fifo_data_buffer.sh -reset_run
...
./fifo_data_buffer.sh -noclean_files

For more information on the script, please type './fifo_data_buffer.sh -help'.
