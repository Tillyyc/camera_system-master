...
#
# Generated by export_simulation on Sun Mar 24 18:32:52 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './shift_reg_ram_1Bit.sh' script.

./shift_reg_ram_1Bit.sh -reset_run
...
./shift_reg_ram_1Bit.sh -noclean_files

For more information on the script, please type './shift_reg_ram_1Bit.sh -help'.
