...
HD_PWD='C:/Users/nuha/Desktop/ece532_project/camera-system-top/camera_system-master/proj/camera_system.runs/shift_reg_ram_1Bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg_ram_1Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_reg_ram_1Bit.tcl
