...
HD_PWD='C:/Users/nuha/Desktop/ece532_project/camera-system-top/camera_system-master/proj/camera_system.runs/weights_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weights.tcl
