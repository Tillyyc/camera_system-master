...
HD_PWD='C:/Users/nuha/Desktop/ece532_project/camera-system-top/camera_system-master/proj/camera_system.runs/fifo_reshape_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_reshape.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_reshape.tcl
