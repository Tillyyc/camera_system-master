...
HD_PWD='C:/Users/nuha/Desktop/ece532_project/camera-system-top/camera_system-master/proj/camera_system.runs/maxpool_linebuffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maxpool_linebuffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maxpool_linebuffer.tcl
