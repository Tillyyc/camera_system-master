...
HD_PWD='C:/Users/nuha/Desktop/ece532_project/camera-system-top/camera_system-master/proj/camera_system.runs/ram_data_in_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_data_in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_data_in.tcl
